 ...
 */
int esttc::hexToInt(const string &s) {
    int result;
    stringstream ss;
    ss << std::hex << s;
    ss >> result;
 ...
 * @return estts::Status indication success/failure of ESTTC command transmission
 */
estts::Status esttc::read_num_rx_packets(std::string &RSSI, std::string &num_rxd) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
    return_status = build_esttc_command(
            esttc_symbols->METHOD_READ,
 ...
 * @return estts::Status indication success/failure of ESTTC command transmission
 */
estts::Status esttc::read_pipe_mode_timeout(std::string &RSSI, std::string &time_period) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
 ...
 * @return estts::Status indication success/failure of ESTTC command transmission
 */
estts::Status esttc::write_pipe_mode_timeout(const string& time_period) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
    string command_body = "";
...
* @return estts::Status indication success/failure of ESTTC command transmission
*/
estts::Status esttc::read_beacon_time_period(std::string &RSSI, std::string &time_period) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
 ...
 * @return estts::Status indication success/failure of ESTTC command transmission
 */
estts::Status esttc::write_beacon_time_period(const string& time_period) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
    string command_body;
    int time_period_int;
    ...
    time_period_int = esttc::hexToInt(time_period);
...
* @return estts::Status indication success/failure of ESTTC command transmission
*/
estts::Status esttc::read_beacon_time_period(std::string &internal_temp) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
 ...
 * @return estts::Status indication success/failure of ESTTC command transmission
 */
estts::Status esttc::force_beacon() {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string command_body;
    command_body = "";
    string response;
...
* @return estts::Status indication success/failure of ESTTC command transmission
*/
estts::Status esttc::read_write_generic_I2C(std::string& send_mode, std::string &slave_address,
    ...
    int bytes_to_read_int = esttc::hexToInt(bytes_to_read);
    int bytes_to_write_int = esttc::hexToInt(bytes_to_write);
    // 0 <= bytes_to_write <= 32
 ...
 * @return estts::Status indication success/failure of ESTTC command transmission
 */
estts::Status esttc::read_uhf_antenna(std::string &antenna_status) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
 ...
 * @return estts::Status indication success/failure of ESTTC command transmission
 */
estts::Status esttc::write_uhf_antenna(const string& antenna_command) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
    string command_body = "";
 ...
 * @return estts::Status indication success/failure of ESTTC command transmission
 */
estts::Status esttc::read_dest_call_sign(std::string &call_sign) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
 ...
 * @return estts::Status indication success/failure of ESTTC command transmission
 */
estts::Status esttc::write_dest_call_sign(const string& call_sign) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
    string command_body = "";
    if (call_sign.size() != 2) {
 ...
 * @return estts::Status indication success/failure of ESTTC command transmission
 */
estts::Status esttc::read_software_version(std::string &version) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
 ...
 * @return estts::Status indication success/failure of ESTTC command transmission
 */
estts::Status esttc::read_beacon_content(std::string &content) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
 ...
 * @return estts::Status indication success/failure of ESTTC command transmission
 */
estts::Status esttc::write_beacon_content(const string content) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
    string command_body = "";
 ...
 * @return estts::Status indication success/failure of ESTTC command transmission
 */
estts::Status esttc::read_fram(std::string &data, string &mem_add) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
    if (mem_add.size() != 8)
        return estts::ES_BAD_OPTION;
 ...
 * @return estts::Status indication success/failure of ESTTC command transmission
 */
estts::Status esttc::write_fram(const string &mem_add, string &data) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
 ...
 * @return estts::Status indication success/failure of ESTTC command transmission
 */
estts::Status esttc::read_secure_mode(std::string &key) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
 ...
 * @return estts::Status indication success/failure of ESTTC command transmission
 */
estts::Status esttc::write_secure_mode(const string &key) {
    estts::Status return_status = estts::ES_UNSUCCESSFUL;
    string response;
